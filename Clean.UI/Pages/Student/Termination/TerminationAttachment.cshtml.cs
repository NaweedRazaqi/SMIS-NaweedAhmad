...
using App.Application.Student.Termination.Commands;
...
namespace Clean.UI.Pages.Student.Termination
{
    ...
    public class TerminationAttachmentModel : BasePage
    {
        public async Task OnGetAsync([FromRoute] int id)
        {
            ...
            var documentTypes = await Mediator.Send(new GetDocumentTypeQuery() { Catagory = "C" });
        ...
        public async Task<IActionResult> OnPostSave([FromBody] TerminationAttachmentCommand command)
        {
        ...
        public async Task<IActionResult> OnPostSearch([FromBody] SearchTerAttachmentQuery query)
        {
