...
namespace Clean.UI.Pages.Student.Registeration
{
    public class AttachmentModel : BasePage
    {
        ...
        public async Task<IActionResult> OnPostSave([FromBody] RegistrationAttachmentCommand command)
        {
        ...
        public async Task<IActionResult> OnPostSearch([FromBody] SearchRegisterationAttachmentQuery query)
        {
