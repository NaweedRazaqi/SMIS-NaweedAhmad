                ...
                if ($.isEmptyObject(self.modal)) {
                    ...
                    clean.data.get({
                        ...
                        success: function (msg) {
                            ...
                            subform.el.append("<input type='hidden'  id='" + subform.el.attr('prefix') + "module' value='" + items[items.length - 2] + "' default='" + items[items.length - 2] + "' class='search' />");
                            subform.el.append("<input type='hidden'  id='" + subform.el.attr('prefix') + "item' value='" + items[items.length - 1] + "' default='" + items[items.length - 1] + "' class='search' />");
