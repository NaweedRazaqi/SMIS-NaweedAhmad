...
namespace Clean.UI.Types
{
    public class BasePage : PageModel
    {
        ...
        public List<SelectListItem> ListOfOwners { get; set; }
        ...
        public List<SelectListItem> ListOfModuleStatus { get; set; }
        public List<SelectListItem> ListOfOwnersParent { get; set; }
        public List<SelectListItem> ListOfSchools { get; set; }
        public List<SelectListItem> ListOfLocations { get; set; }
        public List<SelectListItem> ListOfProfession { get; set; }
        public List<SelectListItem> ListOfSchoolTypes { get; set; }
        public List<SelectListItem> listOfExamType { get; set; }
        public List<SelectListItem> ListOfSchoolCategory { get; set; }

        public List<SelectListItem> ListOfClassTypes { get; set; }

        public List<SelectListItem> ListOfResults { get; set; }
        public List<SelectListItem> ListOfRelatives { get; set; }
        public List<SelectListItem> ListOfClassManagementTypes { get; set; }
        public List<SelectListItem> ListOfExamType { get; set; }
        public List<SelectListItem> ListOfRegistrationTypes { get; set; }
        ...
        public List<SelectListItem> ListOfStudent { get; set; }
        public List<SelectListItem> ListOfSubjects { get; set; }
        public List<SelectListItem> ListOfClassManagements { get; set; }
        public List<SelectListItem> ListOfYears { get; set; }
        public List<SelectListItem> ListOfTeachers { get; set; }
        public List<SelectListItem> ListOfSubjectManagements { get; set; }
        public List<SelectListItem> ListOfserviecetype;
        public List<SelectListItem> ListOfIslamicEducationType;
