...
{
    public class StudentAttachmentCommand : IRequest<List<StudentAttachmentModel>>
    {
    ...
    public class StudentAttachmentCommandHandler : IRequestHandler<StudentAttachmentCommand, List<StudentAttachmentModel>>
    {

        private readonly AppDbContext _context;
        private readonly IMediator _mediator;
        private readonly ICurrentUser _currentUser;
        public StudentAttachmentCommandHandler(AppDbContext context, IMediator mediator, ICurrentUser currentUser)
        {
            _context = context;
            _mediator = mediator;
        ...
        public async Task<List<StudentAttachmentModel>> Handle(StudentAttachmentCommand request, CancellationToken cancellationToken)
        {
            ...
            if (request.Id == null || request.Id == default(decimal))
            {
                ...
                Result = await _mediator.Send(new SearchStudentAttachmentQuery() { Id = StudentAttachment.Id });
